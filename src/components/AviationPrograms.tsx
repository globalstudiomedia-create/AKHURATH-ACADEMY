...
const programs = [
  {
    ...
    path: '/programs/aviation/airport-ground-staff',
  },
  {
    icon: Plane,
    ...
    path: '/programs/aviation/cabin-crew',
  },
  {
    icon: Headphones,
    ...
    path: '/programs/aviation/airport-customer-service',
  },
  {
    icon: Globe,
    ...
    path: '/programs/aviation/aviation-hospitality',
  },
  {
    icon: Ticket,
    ...
    path: '/programs/aviation/airline-ticketing-gds',
  },
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {programs.map((program, index) => (
            <Link key={index} to={program.path} className="block group">
        ...
        <div className="text-center">
          <Link
            ...
            className="inline-block bg-blue-950 hover:bg-blue-900 text-white font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg hover:shadow-xl"
          >
